package io.search.web.rest

import io.search.HierarchtreeApp
import io.search.config.DEFAULT_LANGUAGE
import io.search.domain.User
import io.search.repository.AuthorityRepository
import io.search.repository.UserRepository
import io.search.security.ADMIN
import io.search.security.USER
import io.search.service.UserService
import io.search.service.dto.PasswordChangeDTO
import io.search.service.dto.UserDTO
import io.search.web.rest.vm.KeyAndPasswordVM
import io.search.web.rest.vm.ManagedUserVM
...
@SpringBootTest(classes = [HierarchtreeApp::class])
