...
import io.search.config.ApplicationProperties
...
class HierarchtreeApp(private val env: Environment) {

    private val log = LoggerFactory.getLogger(javaClass)

    /**
     * Initializes hierarchtree.
     *
    ...
    companion object {
        ...
        fun main(args: Array<String>) {
            val env = runApplication<HierarchtreeApp>(*args) { DefaultProfileUtil.addDefaultProfile(this) }.environment
            logApplicationStartup(env)
        }

        @JvmStatic
        private fun logApplicationStartup(env: Environment) {
            val log = LoggerFactory.getLogger(HierarchtreeApp::class.java)
