...
class OpenApiConfiguration {
    ...
    @Bean
    fun noApiFirstCustomizer() = SwaggerCustomizer { docket ->
        docket.select()
            .apis(Predicates.not(RequestHandlerSelectors.basePackage("io.search.web.api")))
    }
    ...
    fun apiFirstDocket(jHipsterProperties: JHipsterProperties): Docket {
        ...
        return Docket(DocumentationType.SWAGGER_2)
            ...
            .select()
            .apis(RequestHandlerSelectors.basePackage("io.search.web.api"))
