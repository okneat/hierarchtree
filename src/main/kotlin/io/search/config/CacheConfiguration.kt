...
class CacheConfiguration(
    ...
    fun cacheManagerCustomizer(): JCacheManagerCustomizer {
        return JCacheManagerCustomizer { cm ->
            createCache(cm, io.search.repository.UserRepository.USERS_BY_LOGIN_CACHE)
            createCache(cm, io.search.repository.UserRepository.USERS_BY_EMAIL_CACHE)
            createCache(cm, io.search.domain.User::class.java.name)
            createCache(cm, io.search.domain.Authority::class.java.name)
            createCache(cm, io.search.domain.User::class.java.name + ".authorities")
