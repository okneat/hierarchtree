...
class StaticResourcesWebConfiguration(private val jHipsterProperties: JHipsterProperties) : WebMvcConfigurer {
    ...
    companion object {
        val RESOURCE_LOCATIONS =
            arrayOf("classpath:/static/app/", "classpath:/static/content/", "classpath:/static/i18n/")
    ...
    fun getCacheControl(): CacheControl =
        CacheControl.maxAge(getJHipsterHttpCacheProperty().toLong(), TimeUnit.DAYS).cachePublic()
