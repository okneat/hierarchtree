package io.search.web.rest.errors
...
class ExceptionTranslator : ProblemHandling, SecurityAdviceTrait {
    ...
    fun handleEmailAlreadyUsedException(
        ex: io.search.service.EmailAlreadyUsedException,
        request: NativeWebRequest
    ): ResponseEntity<Problem>? {
        ...
        return create(
            problem,
            request,
            HeaderUtil.createFailureAlert(applicationName, false, problem.entityName, problem.errorKey, problem.message)
        )
    }

    @ExceptionHandler
    fun handleUsernameAlreadyUsedException(
        ex: io.search.service.UsernameAlreadyUsedException,
        request: NativeWebRequest
    ): ResponseEntity<Problem>? {
    ...
    fun handleInvalidPasswordException(
        ex: io.search.service.InvalidPasswordException,
        request: NativeWebRequest
    ): ResponseEntity<Problem>? {
